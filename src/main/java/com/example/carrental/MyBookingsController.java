...
public class MyBookingsController {
    ...
    @FXML private TableColumn<BookingRecord, Integer> imageCol;
    ...
    public void initialize() {
        ...
        imageCol.setCellValueFactory(new PropertyValueFactory<>("carId"));
        imageCol.setCellFactory(col -> new TableCell<>() {
            ...
            protected void updateItem(Integer item, boolean empty) {
                ...
                if (empty || item == null) {
                    ...
                    BookingRecord record = getTableView().getItems().get(getIndex());
                    Image image = loadCarImage(record.getModel());
    ...
    private Image loadCarImage(String model) {
        ...
        try (java.io.InputStream is = getClass().getResourceAsStream(fallback)) {
            if (is != null) return new Image(is);
        } catch (Exception ignored) {}
        return null;
    }
